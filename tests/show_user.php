...
echo '<pre>';
$user = ($TwitterFox->users()->show('4851396501', "true"));
echo '</pre>';

  echo " <br/> <strong>{$user->get_screen_name()}</strong>: {$user->get_description()} <br/>
               <i> [{$user->get_followers_readable()}] | Joined {$user->get_created_at_formatted('M d Y')}</i> <br/> <br/> ";
